...
# Parse object keeps track of current token and checks if the code matches the grammer
...
class Parser:
    def __init__(self, lexer, emitter):
        ...
        self.peekToken = None
        self.nextToken()
        self.nextToken()  # called twice to init current and peek
    ...
    def match(self, kind):
        if not self.checkToken(kind):
            self.abort(f"Excepted {kind.name}, got {self.curToken.kind.name}")
        self.nextToken()
    ...
    def statement(self):
        ...
        if self.checkToken(TokenType.PRINT):
            ...
            if self.checkToken(TokenType.STRING):
                ...
                # Expect and expression and print the result as a float
